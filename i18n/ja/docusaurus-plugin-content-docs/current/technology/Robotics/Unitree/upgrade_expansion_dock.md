...
注目すべき点として、Unitree公式サイトでは100 TOPS版の拡張ドックが40 TOPS版より **¥236,000** 高く販売されている一方、Jetson Orin NX 16G の完全なキットは単体で約 **¥143,000** で購入できます。そのため、40 TOPS版を購入して自分でアップグレードする方が、コストパフォーマンスの面で大きなメリットがあります。
